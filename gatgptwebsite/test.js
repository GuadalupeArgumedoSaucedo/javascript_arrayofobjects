...
// // Store the length of the courses array
...
// // Filter courses with CourseCode AK-47 and get the price
// const filteredCourses1 = courses.filter(course => course.CourseCode === "AK-47");
// console.log(filteredCourses1[0].Price);

// // Filter affordable courses (price < 50.00)
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Function to render courses based on filter
      ...
      // if (filter === "under50") {
      //   filteredCourses = courses.filter(course => parseFloat(course.Price) < 50);
      // } else if (filter === "50to100") {
      //   filteredCourses = courses.filter(course => parseFloat(course.Price) >= 50 && parseFloat(course.Price) <= 100);
      // } else if (filter === "over100") {
      //   filteredCourses = courses.filter(course => parseFloat(course.Price) > 100);
      // }
          ...
          <div class="col-md-4 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="${course.CourseURL}" class="btn btn-primary">View Course</a>
